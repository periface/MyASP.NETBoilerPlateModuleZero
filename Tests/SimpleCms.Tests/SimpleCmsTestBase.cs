...
{
    public abstract class SimpleCmsTestBase : AbpIntegratedTestBase
    {
        protected SimpleCmsTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<SimpleCmsApplicationModule>();
            modules.Add<SimpleCmsDataModule>();
        }

        public void UsingDbContext(Action<SimpleCmsDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<SimpleCmsDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<SimpleCmsDbContext, T> func)
        {
            T result;
